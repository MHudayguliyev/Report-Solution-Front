...
export const assignUsersToFirm = async <T>(data: T):Promise<string> => {
...
export const setSubscToUser= async <T>(data: T) => {
    return api.postPrivate({url: 'user/create-users-subscription', data, withCredentials: true})
}