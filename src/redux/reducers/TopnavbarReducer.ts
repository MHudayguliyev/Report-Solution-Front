...
const initialState: InitialState = {
    ...
    dashboardCompareDate: moment(new Date()).subtract(1, "day").format("YYYY-MM-DD"),
    reportStartDate: moment(new Date()).subtract(1, "day").format("YYYY-MM-DD"),
...
const TopnavbarReducer = (state=initialState, action: AnyAction) => {
    switch(action.type){
        ...
        case 'SET_DASHBOARD_COMPARE_DATE': 
            return {
                ...state, 
                dashboardCompareDate: action.payload 
            }
        ...
        case 'SET_COMPARE_SWITCH': 
            return {
                ...state, 
                compareSwitch: action.payload
            }
